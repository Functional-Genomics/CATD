...
self_reference_pro<-function(param){
	...
	# P is the preassigned proportion for the pseudo-bulk
	# pDataC is the meta-data for the reference
	RESULTS = Deconvolution(T = T, C = C, method = method, P = P, elem = to_remove, refProfiles.var = Xtrain$ref, STRING = basename(dataset), marker_distrib = marker_distrib, phenoDataC = pDataC) 
